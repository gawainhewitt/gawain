...
function preload(){
    ...
    hallImage = loadImage("/connectivity/images/performanceZone7_small.png", () => {imageLoaded = true});
}
...
function assignSoundToPlayer() {
    if(bufferToPlay === buffer1){
        perfImage0 = loadImage(`/connectivity/images/${theImage}`, () => {imageToUse = perfImage0});
        buffer0 = new Tone.ToneAudioBuffer(`/connectivity/sounds/${theSample}`, () => {
        ...
        perfImage1 = loadImage(`/connectivity/images/${theImage}`, () => {imageToUse = perfImage1});
        buffer1 = new Tone.ToneAudioBuffer(`/connectivity/sounds/${theSample}`, () => {
